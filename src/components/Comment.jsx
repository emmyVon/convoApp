                ...
                <div className='container comment-section'>
                  ...
                  <div className="right-side">
                    <div className='user-info'>
                      ...
                      {Data.currentUser.username === username ? <div><button onClick={()=>handleDelete(id)}><img src={deleteicon} alt='delete-icon' />Delete</button><button onClick={()=>OnEdit(id)}><img src={editicon} alt='edit-icon' />edit</button></div>:<button onClick={switchReply}><img src={replyicon} alt='reply-icon' />reply</button> }
                    </div>
